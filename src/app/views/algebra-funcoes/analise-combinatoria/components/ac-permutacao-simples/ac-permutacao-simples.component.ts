...
@Component({
  templateUrl: './ac-permutacao-simples.component.html',
  styleUrls: ['./ac-permutacao-simples.component.scss']
})
export class AcPermutacaoSimplesComponent implements OnInit {
