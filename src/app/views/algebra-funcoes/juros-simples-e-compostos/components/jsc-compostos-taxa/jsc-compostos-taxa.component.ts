...
import { ICompostoTaxaComand } from './../../shared/juros-simples-e-compostos.model';
...
@Component({
  templateUrl: './jsc-compostos-taxa.component.html',
  styleUrls: ['./jsc-compostos-taxa.component.scss']
})
export class JscCompostosTaxaComponent implements OnInit {
  ...
  onSubmit(): void {
    this.loading = true;
    const jurosSimplesComposto: ICompostoTaxaComand = this.form.value;
