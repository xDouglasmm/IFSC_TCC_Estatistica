...
@Component({
  templateUrl: './por-calculo-percentual.component.html',
  styleUrls: ['./por-calculo-percentual.component.scss']
})
export class PorCalculoPercentualComponent implements OnInit {
