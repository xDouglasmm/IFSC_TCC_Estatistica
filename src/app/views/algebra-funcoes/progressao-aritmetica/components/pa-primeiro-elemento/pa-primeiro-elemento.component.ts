...
import { IPrimeiroElementoComand } from './../../shared/progressao-aritmetica.model';
...
@Component({
  templateUrl: './pa-primeiro-elemento.component.html',
  styleUrls: ['./pa-primeiro-elemento.component.scss']
})
export class PaPrimeiroElementoComponent implements OnInit {
  ...
  onSubmit(): void {
    this.loading = true;
    const progressaoAritmetica: IPrimeiroElementoComand = this.form.value;
