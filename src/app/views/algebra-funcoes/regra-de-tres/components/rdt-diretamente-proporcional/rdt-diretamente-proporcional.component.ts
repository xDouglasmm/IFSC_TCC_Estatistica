...
@Component({
  templateUrl: './rdt-diretamente-proporcional.component.html',
  styleUrls: ['./rdt-diretamente-proporcional.component.scss']
})
export class RdtDiretamenteProporcionalComponent implements OnInit {
