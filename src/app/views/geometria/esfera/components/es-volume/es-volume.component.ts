...
@Component({
  ...
  templateUrl: './es-volume.component.html',
  styleUrls: ['./es-volume.component.scss']
})
export class EsVolumeComponent implements AfterViewInit {
  ...
  makeElements() {
    ...
    const finalRadiusPoint = centerPoint.clone();
    finalRadiusPoint.position.set(
  ...
  changeRadius() {
    ...
    this.isApprox = (Number.isInteger(this.radius ** 3 * 4/3)) ? false : true;
